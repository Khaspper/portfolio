...
// To make the cards tilt or bend when the cursor hovers over it
...
// Loop through each "service" in sservices from index.js and output them
...
const About = () => {
  return (
    <>
      ...
      >
        Hi, I'm a computer science undergrad with a real enthusiasm 
